...
const AdminEditProfile = () => {
  ...
  const { admin, loading: contextLoading, error: contextError, updateAdmin } = useAdmin();
  ...
  const onFormSubmit = async (data) => {
    ...
    try {
      ...
      const response = await fetch('http://localhost:3002/admin/update-profile', {
        method: 'POST',
        credentials: 'include',
        headers: {
    ...
    <div className="admin-edit-profile">
      ...
      <footer className="footer">
        <div className="box">
          ...
          <p>Your trusted healthcare partner, providing seamless access to online consultations, appointment bookings, and medicine deliveries.</p>
        </div>
        <div className="box">
