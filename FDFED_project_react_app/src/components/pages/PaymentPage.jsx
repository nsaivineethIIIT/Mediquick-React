...
const PaymentPage = () => {
    ...
    const fetchOrderDetails = async () => {
        ...
        try {
            ...
            const response = await fetch('http://localhost:3002/patient/api/session-order-details', fetchConfig); 
    ...
    const processPayment = async () => {
        ...
        try {
            const response = await fetch("http://localhost:3002/patient/process-payment", {
                method: "POST",
    ...
    return (
        <>
            <MedicineHeader />
            <div className="container payment-container" style={{ paddingTop: '80px' }}>
