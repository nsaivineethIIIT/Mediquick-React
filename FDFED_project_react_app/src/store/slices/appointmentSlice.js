...
export const fetchOfflineDoctors = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      const response = await fetch(`${API_BASE_URL}/patient/api/doctors/offline`, {
        credentials: 'include'
      });
      if (!response.ok) {
...
export const fetchOnlineDoctors = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      const response = await fetch(`${API_BASE_URL}/patient/api/doctors/online`, {
        credentials: 'include'
      });
      if (!response.ok) {
...
export const fetchDoctorProfile = createAsyncThunk(
  ...
  async (doctorId, { rejectWithValue }) => {
    try {
      const response = await fetch(`${API_BASE_URL}/patient/api/doctor/${doctorId}`, {
        credentials: 'include'
      });
      if (!response.ok) {
...
export const fetchBookedSlots = createAsyncThunk(
  ...
  async ({ doctorId, date, type = 'offline' }, { rejectWithValue }) => {
    try {
...
export const bookAppointment = createAsyncThunk(
  ...
  async (appointmentData, { rejectWithValue }) => {
    try {
      const response = await fetch(`${API_BASE_URL}/appointment/appointments`, {
        method: 'POST',
        headers: {
...
export const cancelAppointment = createAsyncThunk(
  ...
  async (appointmentId, { rejectWithValue }) => {
    try {
      ...
      if (!response.ok) {
        throw new Error(result.error || result.details || 'Failed to cancel appointment');
      }
...
export const fetchDoctorAppointments = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      const response = await fetch(`${API_BASE_URL}/appointment/doctor/appointments`, {
        credentials: 'include'
      });
      if (!response.ok) {
...
export const blockSlot = createAsyncThunk(
  ...
  async ({ date, time, doctorId }, { rejectWithValue }) => {
    try {
      const response = await fetch(`${API_BASE_URL}/appointment/api/block-slot`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json'
        },
